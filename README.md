...
1. Grab `NT8AutoLogin-Setup.exe` from the project's
   [GitHub Releases](../../releases) page (or the latest successful run of
   the **Build Installer** GitHub Action, under its Artifacts) and copy it to
   the Windows PC.
